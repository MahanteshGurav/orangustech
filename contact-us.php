...
<html lang="en">
  <head>
    ...
    <title>Contact Us | Orangus Technologies</title>
	  <!--menu-->
  ...
  <body>
	...
	<div class="jumbotron">
		...
		<p>We're Here To Help You Build Your Next Project.!</p>
		<p><b>Our Motto : Earning Relationship with Trust and Quality of Service. On time , In Budget.</b></p>
	</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
                    <form action="thankyou.php" method="post" role="form" class="contactForm">
                            ...
                            <div class="form-group">
                                    <input type="decimal" class="form-control" name="phone" placeholder="Your Phone (Without country code)" maxlength="10"/>
                            </div>
	...
	<div class="map">
		<div id="google-map" data-latitude="18.658577" data-longitude="73.767807"></div>
	</div>

    
	<div class="jumbotron">
		<h1>We can <span>help build your</span> Project!</h1>
		<p>Partner with us for all your digital needs..!</p>
	</div>
				...
				<div class="row">
					...
					<div class="col-md-4 f-contact">
						...
						<p><i class="fa fa-home"></i> Sector No 25, Plot No 22,<br>
							...
							&nbsp; &nbsp; &nbsp; &nbsp;Pune - 411 044</p>
						<p>Follow Us On:</p>
						<a href="#" target="_blank"><i class="fa fa-facebook-square fa-border" aria-hidden="true"></i></a>
						<a href="#" target="_blank"><i class="fa fa-twitter-square fa-border" aria-hidden="true"></i></a>
						<a href="#"><i class="fa fa-linkedin-square fa-border" aria-hidden="true"></i></a>
						<a href="#"><i class="fa fa-youtube-square fa-border" aria-hidden="true"></i></a>
						<a href="#"><i class="fa fa-instagram fa-border" aria-hidden="true"></i></a>
